...
<head>
    <meta charset="UTF-8">
    <title><?= lang('Welcome.page_title', [4]); ?></title>
...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="#"><?= lang('Menu.home'); ?></a></li>
                <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank"><?= lang('Menu.docs'); ?></a>
                </li>
                <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank"><?= lang('Menu.community'); ?></a></li>
                <li class="menu-item hidden"><a href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/CONTRIBUTING.md" target="_blank"><?= lang('Menu.contribute'); ?></a>
                </li>
                </li>
                <li class="menu-item hidden">
                    <a href="<?= session('lang') === 'en' ? site_url('lang/bn') : site_url('lang/en'); ?>" class="active">
                        <?= session('lang') === 'en' ? lang('Menu.en') : lang('Menu.bn'); ?> <i class="fa-solid fa-arrow-right"></i> <?= session('lang') === 'en' ? lang('Menu.bn') : lang('Menu.en'); ?>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="heroe">
            ...
            <h1><?= lang('Welcome.heroe.h1', [CodeIgniter\CodeIgniter::CI_VERSION]); ?></h1>

            <h2><?= lang('Welcome.heroe.h2'); ?></h2>
        </div>
    ...
    <section>
        ...
        <h1><?= lang('Welcome.section.h1'); ?></h1>

        <p><?= lang('Welcome.section.p1'); ?></p>

        <p><?= lang('Welcome.section.p2'); ?></p>

        <ol>
            <li><a href="https://codeigniter4.github.io/userguide/outgoing/localization.html"><?= lang('Welcome.section.li.one') ?></a></li>
            <li><a href="https://www.youtube.com/watch?v=6XF4NtfrhYM&t=1s"><?= lang('Welcome.section.li.two') ?></a></li>
            <li><a href="https://www.youtube.com/watch?v=GhT4LtkfyRg&t=188s"><?= lang('Welcome.section.li.three') ?></a></li>
        </ol>
    </section>
